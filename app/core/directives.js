angular.module('eVis.directives', [])
    ...
    .directive('appHeader', function () {
        return {
            ...
            replace: true,
            controllerAs: '$ctrl',
            template: '<header><a href="javascript:window.history.back();" title=""><i class="icon ion-android-arrow-back" style="font-size:2em; color: #F4CC6A"></i></a><h4>{{pageTitle}}</h4><a href="#" class="config-link" title="config"></a></header>',
            scope: {
                pageTitle: '@'
            }
        };
    ...
    .directive('logOut', ['$state', function ($state) {
        return {
            link: function ($scope, element) {
                element.on('click', function () {

                    storage.setItem(Constants.DBKeys.AUTHENTICATED, false);
                    $state.go("login");
    ...
    .directive('growingList', function () {
        return {
            restrict: 'EA',
            template: '<style> input[disabled]{background: none;}.title .row, .list-items .row,  .list-items .col{padding:2px;}.list-items .item{border:none;}.list-items .col{border-bottom: 1px solid #32A79D;}.list-items.row.ng-enter {-webkit-animation: fadeInDown .2s;animation: fadeInDown .2s;}.list-items.row.ng-leave {-webkit-animation: fadeOutDown .2s;animation: fadeOutDown .2s;}</style>' +
    ...
    .directive('starRating', function () {
        return {
            restrict: 'EA',
            template: '<style>.star-rating {margin: 0;padding: 0;display: inline-block;}.star-rating .star {padding: 1px;color: #ddd;font-size: 20px;text-shadow: .05em .05em #aaa;list-style-type: none;display: inline-block;cursor: pointer;}.star-rating .star.filled {color: #fd0;}.star-rating.readonly .star.filled {color: #666;}</style>' +
    ...
    .directive('preImg', function () {
        return {
            ...
            templateUrl: 'app/views/pre-img.html'
        };
    })
